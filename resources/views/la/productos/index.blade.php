...
@section("contentheader_description", "Listado de Productos")
...
@la_access("Productos", "create")
	<button class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#AddModal">Añadir Producto</button>
@endla_access
@endsection
