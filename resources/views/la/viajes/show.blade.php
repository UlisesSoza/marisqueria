...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $viaje->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Viajes", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/viajes/'.$viaje->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Viajes", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.viajes.destroy', $viaje->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/viajes') }}" data-toggle="tooltip" data-placement="right" title="Back to Viajes"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'partida')
						@la_display($module, 'llegada')
						@la_display($module, 'capitan')
						@la_display($module, 'producto')
						@la_display($module, 'lancha')
						@la_display($module, 'gasto')
						@la_display($module, 'marinos')
						@la_display($module, 'comision')
					</div>
				</div>
			</div>
		</div>
