...
class CreateEmployeesTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Employees", 'employees', 'name', 'fa-group', [
            ["name", "Nombres", "Name", false, "", 3, 250, true],
            ["lastname", "Apellidos", "Name", false, "", 3, 20, true],
            ["password", "Contraseña", "Password", false, "", 5, 20, true],
            ["email", "Usuario", "Name", true, "", 5, 250, true],
        ]);
