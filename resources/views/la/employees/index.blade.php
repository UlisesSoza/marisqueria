...
@la_access("Employees", "create")
	<button class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#AddModal">Añadir Usuario</button>
@endla_access
@endsection
			...
			<div class="modal-body">
				<div class="box-body">
					...
					<div class="form-group">
						...
						<select class="form-control" required="1" data-placeholder="Seleccionar Rol" rel="select2" name="role">
